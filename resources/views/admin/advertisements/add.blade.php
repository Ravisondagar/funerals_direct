    ...
    @csrf
      <div class="box-body">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Advertisement Name" name="text" value="{!! old('text') !!}">
          @if($errors->has('text'))<span>{!! $errors->first('text') !!}</span>@endif
        </div>
        <div class="form-group">
          <label for="exampleInputEmail1">Link</label>
          <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Advertisement Name" name="link" value="{!! old('link') !!}">
