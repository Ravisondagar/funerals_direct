	...
	<div class="admin-dashboard clearfix">
		...
		<div class="dashboard-content">
			<div class="dashboard-title">
				<div class="inner-wrap"><div class="menu-icon"></div><strong>STEP 5:</strong> Flowers</div>
			</div>
			<div class="page-note">
					...
					<div class="funeral-box">
						<div class="funeral-box-header">
							<div class="add-btn">
								<ul>
									<li class="relative">
										<a href="#" class="green add-btn-link">Add Flowers</a>
										...
										<div class="popup-tooltip">
											...
											<div class="popup-tooltip-text">
												<h3>Click the “Add Flowers” button to add another flower option.</h3>
												<p>You can always remove it later if needed.</p>
								...
								<div class="row clearfix">
										...
										<div class="burial-package-add-form">
											<form>
												<div class="package-box">
													<h4><span>Flower Option 1</span></h4>
													<ul>
														<li class="clearfix">
															<div class="left">
																<label>Flower Title:</label>
															</div>
															<div class="right">
																<div class="form-group">
																	<input type="text" class="form-control" placeholder="Give your flowers a title">
																</div>
															</div>
														</li>
														<li class="clearfix">
															...
															<div class="right">
																<div class="form-group">
																	<input type="text" class="form-control" placeholder="e.g. $200.00">
																</div>
															</div>
														</li>
														<li class="clearfix">
									...
									<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
										<div class="flower-desc">
											<p><span class="red">$200.00</span> - Flowers Title</p>
