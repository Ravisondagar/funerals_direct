	...
	<div class="admin-dashboard clearfix">
		...
		<div class="dashboard-content">
			<div class="dashboard-title">
				<div class="inner-wrap"><div class="menu-icon"></div><strong>STEP 7:</strong> Funeral Programme &amp; Printing</div>
			</div>
			<div class="page-note">
					...
					<div class="funeral-box">
						<div class="funeral-box-header">
							<div class="add-btn">
								<ul>
									<li class="relative">
										<a href="#" class="green add-btn-link">Add New Option</a>
												...
												<div class="package-box">
													...
													<ul>
														<li class="clearfix">
															...
															<div class="right">
																<div class="form-group">
																	<input type="text" class="form-control" placeholder="Give your Programme a title">
																</div>
															</div>
														</li>
														<li class="clearfix">
															...
															<div class="right">
																<div class="form-group">
																	<div class="catering-price-input">
																		...
																		<input type="text" class="form-control" placeholder="e.g. $20.00 or 0.00 (if free)">
																	</div>
																</div>
															</div>
														</li>
														<li class="clearfix">
															...
															<div class="right">
																<div class="form-group">
																	<textarea class="form-control" placeholder="Write up a brief description about the funeral programme"></textarea>
																</div>
															</div>
														</li>
														<li class="clearfix">
