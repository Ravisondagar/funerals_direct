		...
		<div class="container">
				...
				<div class="blog-left">
					<ul>
						<li class="clearfix">
							...
							<div class="right">
								<h3><a href="#">Why you should plan ahead</a></h3>
								<div class="blog-by">
									27 September 2017   |   <a href="#">By Sandra Morris</a>
								</div>
								...
								<div class="blog-view"><a href="#">Read More</a></div>
							</div>
						</li>
						<li class="clearfix">
							<div class="left">
			...
			<div class="col-lg-4 col-md-4 col-sm-5 col-xs-12">
				<div class="blog-right">
					...
					<div class="blog-categories">
						<h5>Recent Posts</h5>
						<ul class="recent-post-right-list">
							<li class="clearfix">
								<div class="post-img"><img src="images/recent-post-img.jpg"></div>
								<div class="post-desc">
									<a href="#">Why you should plan ahead</a>
									<div class="blog-by">
										27 September 2017 <a href="#">By Sandra Morris</a>
									</div>
								</div>
